...
public class MessageSender4Predicate {
    ...
    List<City> iscritti = Arrays.asList(
     ...
     public List<City> getIscrittiFiltratiPer(Predicate<City> pred){
    ...
    public static void main(String[] args) {
      MessageSender4Predicate ms = new MessageSender4Predicate();
 
      // Predicates
      Predicate<City> allGiovaniDonne = p -> p.getSesso().equals("F") && p.getEta() > 17 && p.getEta() < 30;
      Predicate<City> allMaschi = p -> p.getSesso().equals("M");
